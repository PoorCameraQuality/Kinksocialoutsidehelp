#!/usr/bin/env node
/**
 * Alpha verification screenshots — run with dev stack up (npm run dev).
 * Output: docs/audits/ui/screenshots/latest-alpha/
 */
...
const outDir = join(process.cwd(), 'docs', 'audits', 'ui', 'screenshots', 'latest-alpha')
