/**
 * Patch deploy: move Recent posts into the left column (web only).
 * Usage: SSH_PASS='...' node scripts/vps/patch-profile-recent-posts-vps.mjs
 */
...
async function main() {
  ...
  conn.end()
  console.log('\nPATCH OK — hard-refresh kink.social/profile on desktop')
}
