/** Upload changed media-privacy source files and rebuild API on VPS. */
...
const files = [
  ...
  'packages/api/src/lib/media-pipeline.ts',
  'packages/api/src/lib/media-asset-viewer.ts',
  'packages/api/src/routes/profile-photos.ts',
  'packages/api/src/lib/media-pipeline.test.ts',
  'packages/shared/src/media-types.test.ts',
]
