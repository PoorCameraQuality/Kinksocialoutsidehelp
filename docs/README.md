...
| [OPERATIONS.md](./OPERATIONS.md) | Ops |
| [TROUBLESHOOTING.md](./TROUBLESHOOTING.md) | Common failures |
| [KNOWN_LIMITATIONS.md](./KNOWN_LIMITATIONS.md) | Current limits |
| [DOCUMENTATION_CLEANUP_INVENTORY.md](./DOCUMENTATION_CLEANUP_INVENTORY.md) | Docs cleanup inventory |
| [REPOSITORY_EXTRACTION_INVENTORY.md](./REPOSITORY_EXTRACTION_INVENTORY.md) | What was kept or omitted in this snapshot |
| [REMOVED_FILES_SUMMARY.md](./REMOVED_FILES_SUMMARY.md) | Omitted categories |
