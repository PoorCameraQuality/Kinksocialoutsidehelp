/** 50 states + DC (US Census state FIPS). Excludes territories (60, 66, 69, 72, etc.). */
export const US_STATES: { fips: string; name: string }[] = [
...
export const DEFAULT_POPULATION_THRESHOLD = 10_000
export const MIN_PLACES_PER_STATE = 5
